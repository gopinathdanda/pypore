# -*- coding: utf-8 -*-
#
# Pypore documentation build configuration file, created by
# sphinx-quickstart on Thu Aug 22 18:12:01 2013.
#
...
latex_documents = [
    ('index', 'pypore.tex', u'Pypore Documentation',
     u'Will Parkin', 'manual'),
]
...
man_pages = [
    ('index', 'pypore', u'Pypore Documentation',
     [u'Will Parkin'], 1)
]
...
texinfo_documents = [
    ('index', 'pypore', u'Pypore Documentation',
     u'Will Parkin', 'pypore', 'Library and gui for analyzing nanopore translocation events.',
     'Miscellaneous'),
]
...
MOCK_MODULES = ['Cython', 'tables', 'PySide', 'pyqtgraph']
